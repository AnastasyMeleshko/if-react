                            ...
                            <div className="header-nav">
                                ...
                                <div className="header-icons">
                                    ...
                                    <div className="hidden-menu-icon burger-menu">
                                        <BurgerLine lineNumber={"one"} key={this.lineNumber}/>
                                        <BurgerLine lineNumber={"two"} key={this.lineNumber}/>
                                        <BurgerLine lineNumber={"three"} key={this.lineNumber}/>
                                    </div>
                                </div>
                            </div>
                        </nav>
                        <div className="main-header-content">
                            <h1 className="col-lg-12">Discover stays<br/>to live, work or just relax</h1>
                            <form action="" className="form-main col-lg-12">
                                <div className="form-destination form-destination-shown form-item">
                                    <input type="text" id="user-destination" className="form-input input-destination"
                                           name="user-destination" required value autoComplete="off"/>
                                ...
                                <div className="left-container">
                                    <div className="form-destination-hidden form-item">
                                        <div className="form-img-loupe">
                                            <svg className="form-loupe">
                                                <use href="./img/Sprite.svg/#loupe"></use>
                                            </svg>
                                        </div>
