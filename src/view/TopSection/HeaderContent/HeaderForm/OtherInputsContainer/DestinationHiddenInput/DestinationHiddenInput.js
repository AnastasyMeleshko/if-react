...
function DestinationHiddenInput(props) {
    ...
    return (
        <div className="form-destination-hidden form-item">
            ...
            <FormInput  onChange={funcForChange} value={props.value} type="text" id="user-destination-hidden" className="input-destination" name="user-destination" required="required"/>
            {
                (width < 500) ?
                    <FormLabel
                        className="label-destination-hidden label-destination"
                        htmlFor="user-destination-hidden"
                        labelText="Destination or hotel name"
                    />
                    :
                    <FormLabel
                        className="label-destination-hidden label-destination"
