    ...
    render() {
        return (
            ...
            <div className="form-destination form-destination-shown form-item">
                <input type="text" id="user-destination" className="form-input input-destination"
                       name="user-destination" required autoComplete="off"/>
                <label className="form-label label-destination" htmlFor="user-destination">Your
            ...
            <div className="left-container">
                <div className="form-destination-hidden form-item">
                    ...
                    <input type="text" id="user-destination-hidden"
                           className="form-input input-destination" name="user-destination" required
                           autoComplete="off"/>
                    <label className="form-label label-destination-hidden label-destination"
                           htmlFor="user-destination-hidden">
                        Your destination or hotel name
                    </label>
                </div>
                <div className="form-dates">
                    <div className="form-item check-inn">
                        <input type="text" className="form-input input-date"
                               name="user-check-in-date" id="form-user-check-in" required
                               autoComplete="off"/>
                        <label className="form-label label-inn" htmlFor="form-user-check-in">Check-in
                            date</label>
                    </div>
                    <div className="form-item check-out">
                        <input type="text" className="form-input input-date"
                               name="user-check-out-date" id="form-user-check-out" required
                               autoComplete="off"/>
                        <label className="form-label label-out" htmlFor="form-user-check-out">Check-out
                            date</label>
                    </div>
                </div>
                    ...
                    <div className="form-numbers-wrap">
                        <div className="form-numbers">
                            <div className="form-adults form-numbers-item">
                                ...
                                <label className="form-label label-adults"
                                       htmlFor="form-user-adults">Adults</label>
                            </div>
                            <div className="form-children form-numbers-item">
                                <input type="text"
                                       className="form-input input-children numbers-input"
                                       name="user-children" id="form-user-children"
                                       autoComplete="off"/>
                                <label className="form-label label-children"
                                       htmlFor="form-user-children">Children</label>
                            </div>
                            <div className="form-rooms form-numbers-item">
                                ...
                                <label className="form-label label-rooms"
                                       htmlFor="form-user-rooms">Rooms</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="search-button-wrap">
                    <button className="search-button" name="Search" type="button">Search</button>
                </div>
            </div>
        </form>
        );
